...
Today the package holds only enough to prove the adapter can import it — the
filename grammar, the frontmatter header and the listing flattener land on top
of this seam.
"""
